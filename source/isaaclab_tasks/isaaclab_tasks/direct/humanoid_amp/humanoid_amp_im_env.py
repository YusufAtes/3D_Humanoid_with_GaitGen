...
class HumanoidAmpEnv(DirectRLEnv):
    ...
    def _get_rewards(self) -> torch.Tensor:
        ...
        # imitation_coeff = torch.where(self.desired_speeds > 0.6, imitation_coeff * torch.exp( - (self.desired_speeds - 0.6)), imitation_coeff)
        ...
        #09.02 Configini bu rewardı absolute yapıp dene sonrada 0.5 den baslat imitation decayi ve e^-1 yap
        vel_reward_fwd = torch.exp(-3.0 * torch.abs(forward_speed - (self.desired_speeds * 2.4)))
